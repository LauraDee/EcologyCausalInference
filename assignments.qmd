...
-   7 minute presentation + 2 minutes for questions\
...
*Content*
For Project Option 1, final reports should include:
...
For Project Option 2, final reports should include:\
...
-Review of methods or approaches that could be helpful, which could cover: a) how do these approaches/methods compare to what is currently being done on this topic?; b) what do you propose to do and which methods or study design would you use -- and why?; c) discussion of implications and potential uses or changes -- or areas of advances that are needed; and d) brief conclusions.

...
-   Share your results, explain how you checked their robustness, AND contextualize them with the important limitations and assumptions of the method(s) you used, including their assumptions and why or why not they are met\
...
As noted above, as a class we will compile a running [glossary](https://docs.google.com/document/d/1HV2mUU-gQSzwEqg2KrKi2-I3zWorCK94xQmfw5ixig0/edit?usp=drive_link) of “jargon” and terms and concepts in causal inference to provide notes as reference.
...
| Assignment | Deadline |
|:---------------------------------:|:-----------------------------------:|
| [Pre-course survey](https://forms.gle/RMQfEYqwvuioHab58) | Wednesday 8/26 |
| Identify project focus (option 1 or 2). Identify research questions + create a first draft of a DAG for our in class DAG workshop on 9/20 | **Prior to class:** Due 9/20 (by email) |
| Revised draft of Project Question and revised DAG OR literature review proposal (2 page max) | 10/12 (by email) |
| One on One Consultations: find 15 mins to meet with Laura | Before Thanksgiving Break |
| Short presentation on research questions + DAG OR literature review topic, its significance, + proposed methods (prelim results) | Wednesday 11/2 **(bring to class for in class workshop day)** |
| Presentation of final project | Nov 30 and Dec 2 |
| Final project write-up due by email | Dec 6th by midnight |
